...
TC_72: Validate Student Have Send Bicycles Register But Check-In Period Overlaps With Stay Period
    [Documentation]  This test case validate have send bicycles register But Check-In Period Overlaps With Stay Period
    ...              Result return message faily
...
TC_73: Validate Student Have Send Motorbike Register But Check-In Period Overlaps With Stay Period
    [Documentation]  This test case validate have send Motorbike Register But Check-In Period Overlaps With Stay Period
    ...              Result return message faily
    [Tags]  RegisterServiceFaily
...
TC_74: Validate Student Have Send Clean The Area Register But Check-In Period Overlaps With Stay Period
    [Documentation]  This test case validate have send Clean The Area Register But Check-In Period Overlaps With Stay Period
    ...              Result return message faily
    [Tags]  RegisterServiceFaily
...
TC_75: Validate Student Have Send Bicycles Register But Is't Register time
    [Documentation]  This test case validate have send bicycles register But Is't Register tim
    ...              Result return message faily
    [Tags]  RegisterServiceFaily
...
TC_76: Validate Student Have Send Motorbike Register But Is't Register time
    [Documentation]  This test case validate have send Motorbike Register But Is't Register tim
    ...              Result return message faily
    [Tags]  RegisterServiceFaily
...
TC_77: Validate Student Have Send Clean The Area Register But Is't Register time
    [Documentation]  This test case validate have send Clean The Area Register But Is't Register tim
    ...              Result return message faily
    [Tags]  RegisterServiceFaily
...
TC_78: Validate Student Have Send Bicycles Register But Over Time
    [Documentation]  This test case validate have send bicycles register But Over Time
    ...              Result return message faily
    [Tags]  RegisterServiceFaily
...
TC_79: Validate Student Have Send Motorbike Register But Over Time
    [Documentation]  This test case validate have send Send Motorbike But Over Timed
    ...              Result return message faily
    [Tags]  RegisterServiceFaily
...
TC_80: Validate Student Have Send Clean The Area Register But Over Time
    [Documentation]  This test case validate have send Clean The Area Register But Over Time
    ...              Result return message faily
    [Tags]  RegisterServiceFaily
