...
*** Variables ***
*** Test Cases ***
TC-01:Validate Room Type Have AirConditioned And Number 4 people.  ${TC_09.USERNAME}   ${TC_09.PASSWORD}   ${messAirConditioned}   ${number_4}
TC-02:Validate Room Type Have AirConditioned And Number 6 people.    ${TC_09.USERNAME}   ${TC_09.PASSWORD}   ${messAirConditioned}   ${number_6}
TC-03:Validate Room Type Have AirConditioned And Number 8 people.    ${TC_09.USERNAME}   ${TC_09.PASSWORD}   ${messAirConditioned}   ${number_8}
*** Keywords ***
