...
*** Variables ***
*** Test Cases ***
TC-01:Validate Room Type Have AirConditioned And Number 4 people.
...
TC-02:Validate Room Type Have AirConditioned And Number 6 people.
       [Documentation]  This test case verifies then case Room Type Have AirConditioned
       ...              and 6 people input by user it will be displayed the conditon on After Login
     ${USERNAME}   ${PASSWORD}   ${messAirConditioned}   ${number_6}
TC-03:Validate Room Type Have AirConditioned And Number 8 people.
      [Documentation]  This test case verifies then case Room Type Have AirConditioned
      ...              and 6 people input by user it will be displayed the conditon on After Login
